...
pdf:
	...
	pandoc -t latex --filter pandoc-crossref -o output-listings.pdf -i demo.md -M listings --listings
...
latex:
	...
	pandoc -t latex --filter pandoc-crossref -o output-listings.latex -i demo.md -M listings --listings
